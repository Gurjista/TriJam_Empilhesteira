...
public class Timer : MonoBehaviour
{
    ...
    public TextMeshProUGUI timerText; // Refer�ncia para o objeto TextMeshPro

    private void Start()
    {
        currentTime = initialTime; // Inicializa o timer com o tempo inicial
        UpdateTimerDisplay(); // Atualiza a exibi��o do timer
    }
    ...
    private void Update()
    {
        ...
        {
            currentTime = 0; // Garante que o tempo n�o fique negativo
            UpdateTimerDisplay(); // Atualiza a exibi��o do timer
